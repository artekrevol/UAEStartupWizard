...
// Ensure ESM can find the module by providing the correct extension
 ...
 */
async function processBusinessSetupInfo() {
  try {
    ...
    console.error(`Error processing business setup information: ${error.message}`);
    return false;
  }
}
